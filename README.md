...
* **Role:** Finance Assistant & Web Developer
* **Location:** Korangi Creek, Karachi, Pakistan
* **Online Handle:** `@VexorNull`

## 🛠️ Tech Stack & Skills
* **Languages:** HTML5, CSS3, JavaScript, PHP
* **Tools & Platforms:** GitHub Pages, Vercel, Firebase Realtime Database & Auth
* **Utilities:** Termux, ADB, Shizuku, Blogger Custom XML Themes

## 📂 Repository Structure
* `index.html` — Main semantic biography page with embedded Schema Markup.
